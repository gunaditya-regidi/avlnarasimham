...
function Subscription() {
  ...
  return (
    <section id='pricing'>
      <div className='2xl:py-10 py-8'>
        <div className='container-fluid px-4 xl:px-8'>
          <div className='flex flex-col gap-10 md:gap-20'>
            ...
            <div className='gap-6 overflow-visible'>
              <div className='relative w-full'>
                <div className='absolute top-0 bottom-0 right-0 left-1/2 bg-[#673DE6] rounded-[40px] -z-10' />
                <div className='relative z-10'>
              {startupPlanList?.map((items: any, index: number) => (
                <div
                  className={`${items.plan_bg_color} p-6 md:p-10 rounded-[40px] relative z-10`}
                  key={index}
                >
